...
import ir.beigirad.zeroapplication.isTablet
...
abstract class BaseDialogFragment : DialogFragment() {
    ...
    protected open fun initToolbar() {
        ...
        when {
            context!!.isTablet() -> this.toolbar.navigationIcon =
                context!!.resources.getDrawable(R.drawable.item_black_cross_icon)
            beFullScreen() -> this.toolbar.navigationIcon =
                context!!.resources.getDrawable(R.drawable.item_back_button)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (beFullScreen() && !context!!.isTablet())
